...
def reconstruct(pair_1, pair_2, filename, params, limits):
    ...
    pair.saveData(filename='work materials/'+filename+'/')
    # points_cloud = pair.getPointsCloud(limits=limits)
    # points_cloud.writeToFile(filename='work materials/'+filename+'/out.ply')
    # points_cloud = pair.transformPCtoMainCoordinateSystem(points_cloud)
    # points_cloud.writeToFile(filename='work materials/'+filename+'/out.ply')
